...
export const southAfricaTrip: TripData = {
  ...
  accommodations: [
    ...
    {
      nameEn: 'Bayview Hotel — Plettenberg Bay',
      nameAr: 'فندق أوباي غولف آند سبا — جورج',
      descEn: 'Bayview Hotel is a 4-star hotel in Plettenberg Bay along South Africa\'s famous Garden Route. It offers comfortable en-suite rooms, free Wi-Fi, an on-site restaurant, outdoor pool, and is within walking distance of beaches, shops, and local attractions. The hotel is approximately 90 minutes from George Airport.',
      descAr: 'منتجع ساحلي فاخر على طريق الحديقة الخلاب، على بعد دقائق من مطار جورج. يضم ملعب غولف ١٨ حفرة من تصميم إرني إلز، ٣ مطاعم فاخرة، سبا حائز على جوائز، ٥ مسابح خارجية، صالة رياضية، ملاعب تنس وسكواش. ١٠٠ غرفة فاخرة مع إطلالات خلابة على المحيط الهندي وجبال أوتينيكوا.',
